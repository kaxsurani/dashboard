...
const UserGrow = () => {
  return (
    <div className="flex flex-col w-[64.1%] h-[450px] mr-2 mb-5">
      ...
      <div className="w-full h-full mb-2 bg-[#fbfbf9] rounded-sm shadow-xl transition-shadow border ">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-8 ml-7 mt-6 ">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 mr-9">
            <IoCaretDown className="text-[#f44236] text-[20px]" />
            <h5 className="text-[#888] text-[16px]">
            2739</h5>
          </div>
        </div>
        <div className="flex items-center justify-between">
